...
class RockStacking(Node):
    ...
    def stage2_callback(self, msg):
        ...
        if self.saved_plane_distance is not None:
            ...
            drop_plunge = (self.saved_plane_distance - (self.saved_plane_distance - self.placing_z) - (self.saved_plane_distance - (self.safe_height+pick_plunge)) - self.safe_height) #in mm
