...
class RockStacking(Node):
    ...
    def stage2_callback(self, msg):
        ...
        self.send_gcode(f'G1 X{self.rock_x*self.approch_coeff*2:.1f} Y{(self.rock_y*self.approch_coeff*2):.1f} Z-{self.rock_second_approch} F{self.unloaded_speed}')
        time.sleep(5)
