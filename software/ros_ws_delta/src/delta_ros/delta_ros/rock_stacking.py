...
class RockStacking(Node):
    ...
    def stage2_callback(self, msg):
        ...
        rock = msg.poses[1] if len(msg.poses) > 1 else rock = msg.poses[0]         self.rock_x = rock.position.x * 1000
        self.rock_y = rock.position.y * 1000
    ...
    def stage3_callback(self, msg):
        rock = msg.poses[1] if len(msg.poses) > 1 else  rock = msg.poses[0]  # third measure for rock picking 
